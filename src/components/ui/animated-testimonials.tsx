      ...
      <div className="relative grid grid-cols-1 md:grid-cols-2 gap-20">
        ...
        <div className="flex justify-between flex-col py-4">
          ...
          >
            ...
            <motion.p className={cn("text-lg mt-8", mutedTextColor)}>
          ...
          <div className="flex gap-4 pt-12 md:pt-0">
            <button
              onClick={handlePrev}
              className={cn("h-7 w-7 rounded-full flex items-center justify-center group/button transition-all hover:scale-110", secondaryBg, textColor)}
            >
