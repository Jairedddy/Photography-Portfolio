...
export const PHOTOS: Photo[] = [
  // Page 1 — [P, L, L, P, P, L, P, P, P, P, L, L]
  ...
  { id: '6',  url: '/images/9.jpg',  title: 'Crimson Ceiling',        category: 'Portrait',     description: "The eyes don't blink. Something up there has all the answers.", aspectRatio: 1.776, licenseType: LicenseType.EDITORIAL_ONLY },
  ...
  // Page 2 — [P, P, L, P, P, P, P, L, L, P, P, L]
  ...
  { id: '16', url: '/images/37.jpg', title: 'After Hours Shack',      category: 'Street',       description: "No ocean in sight. Just light that shouldn't be this warm, grain that shouldn't feel this alive.", aspectRatio: 0.563, licenseType: LicenseType.RIGHTS_MANAGED },
  { id: '17', url: '/images/39.jpg', title: 'False Idols',            category: 'Abstract',     description: "The knobs are analog. The song is a warning. Nobody turned it off.", aspectRatio: 0.563, licenseType: LicenseType.ROYALTY_FREE },
  { id: '18', url: '/images/40.jpg', title: 'Crowned',                category: 'Portrait',     description: "His back to the camera, the cliffs behind him, and a country floating above his head like a benediction.", aspectRatio: 0.563, licenseType: LicenseType.EDITORIAL_ONLY },
  ...
  // Page 3 — [P, P, L, L, P, P, P, P, P, P, L, L]
  { id: '25', url: '/images/42.jpg', title: 'Lone Pedestrian',        category: 'Street',       description: "Dead center. Umbrella up. The road is symmetrical. Only the person is not.", aspectRatio: 0.563, licenseType: LicenseType.RIGHTS_MANAGED },
  { id: '26', url: '/images/43.jpg', title: 'Last Round',             category: 'Street',       description: "Two glasses. One year ending. The grain remembers what the mind won't.", aspectRatio: 0.563, licenseType: LicenseType.ROYALTY_FREE },
  { id: '27', url: '/images/4.jpg',  title: 'Frosticks',              category: 'Street',       description: "The sign glows like it means it. Everything below it is dark. Cold has never looked this inviting.", aspectRatio: 2.165, licenseType: LicenseType.RIGHTS_MANAGED },
  { id: '28', url: '/images/45.jpg', title: 'Collective Noise',       category: 'Street',       description: "The stage is the only thing with a plan. The crowd just showed up and became one thing.", aspectRatio: 1.778, licenseType: LicenseType.ROYALTY_FREE },
  { id: '29', url: '/images/41.jpg', title: 'Unannounced',            category: 'Street',       description: "The engine was already running. The night had no warning. Neither did whoever was inside.", aspectRatio: 0.563, licenseType: LicenseType.EDITORIAL_ONLY },
  { id: '30', url: '/images/38.webp',title: 'The Backlit Shelf',      category: 'Abstract',     description: "The bottles glow. The bar doesn't. You're already on the wrong side of the counter.", aspectRatio: 0.563, licenseType: LicenseType.RIGHTS_MANAGED },
  { id: '31', url: '/images/44.jpg', title: 'One Light Left',         category: 'Abstract',     description: "The playground emptied hours ago. One streetlight stayed. The bars cast shadows like they're counting.", aspectRatio: 0.563, licenseType: LicenseType.ROYALTY_FREE },
  { id: '32', url: '/images/46.png', title: 'High Tide, Raised Hands',category: 'Portrait',     description: "Two of them reaching for something. One just standing. The ocean doesn't ask which is which.", aspectRatio: 0.750, licenseType: LicenseType.PERSONAL_USE },
  { id: '33', url: '/images/47.png', title: 'Walking Into Gold',      category: 'Portrait',     description: "Sunset at his back. The sea at his feet. He didn't look back, and the light didn't ask him to.", aspectRatio: 0.750, licenseType: LicenseType.RIGHTS_MANAGED },
  { id: '34', url: '/images/48.jpg', title: 'Campus Dusk',            category: 'Street',       description: "The sky was the whole point. Everyone walking underneath it had no idea.", aspectRatio: 0.563, licenseType: LicenseType.ROYALTY_FREE },
  { id: '35', url: '/images/23.jpg', title: 'Exit Velocity',          category: 'Automotive',   description: "One wheel. One taillight. The rest is already gone.", aspectRatio: 1.780, licenseType: LicenseType.EDITORIAL_ONLY },
  { id: '36', url: '/images/24.jpg', title: 'Dead Stop',              category: 'Automotive',   description: "The rain had an opinion. The road didn't. Neither did the plan.", aspectRatio: 1.778, licenseType: LicenseType.RIGHTS_MANAGED },
  // Page 4 — [L, L, L, P, P, P, P, P, P, L, L, L]
  { id: '37', url: '/images/25.jpg', title: 'Brake Point',            category: 'Abstract',     description: "White on iron. Denim on chrome. One foot decides everything.", aspectRatio: 1.778, licenseType: LicenseType.ROYALTY_FREE },
  { id: '38', url: '/images/26.jpg', title: 'Intermission',           category: 'Abstract',     description: "Three basins. No one. The bass still bleeds through the wall.", aspectRatio: 1.780, licenseType: LicenseType.EDITORIAL_ONLY },
  { id: '39', url: '/images/27.jpg', title: 'Filament',               category: 'Abstract',     description: "Borrowed warmth. The ceiling holds more than anyone asked it to.", aspectRatio: 1.778, licenseType: LicenseType.PERSONAL_USE },
  { id: '40', url: '/images/28.jpg', title: 'The Arrangement',        category: 'Abstract',     description: "Hot chocolate. Flowers. December. She didn't have to say a word.", aspectRatio: 0.563, licenseType: LicenseType.RIGHTS_MANAGED },
  { id: '41', url: '/images/29.jpg', title: 'The Vigil',              category: 'Abstract',     description: "The lamp and the leaves. Neither of them needed company.", aspectRatio: 0.563, licenseType: LicenseType.ROYALTY_FREE },
  { id: '42', url: '/images/30.jpg', title: 'Pale Gold',              category: 'Abstract',     description: "A cold glass. A winter night. The flowers didn't ask what the occasion was.", aspectRatio: 0.563, licenseType: LicenseType.EDITORIAL_ONLY },
  { id: '43', url: '/images/31.jpg', title: 'The Better Order',       category: 'Abstract',     description: "Someone drew a leaf in the foam. The flowers almost looked jealous.", aspectRatio: 0.562, licenseType: LicenseType.RIGHTS_MANAGED },
  { id: '44', url: '/images/32.jpg', title: 'Under Heaven',           category: 'Architecture', description: "Sky. Tree. Temple. The angle made all three older than they are.", aspectRatio: 0.563, licenseType: LicenseType.ROYALTY_FREE },
  { id: '45', url: '/images/33.jpg', title: 'Halo Effect',            category: 'Architecture', description: "The sun set behind it. The lake caught what was left. Neither asked for credit.", aspectRatio: 0.563, licenseType: LicenseType.EDITORIAL_ONLY },
  { id: '46', url: '/images/34.jpg', title: 'Two Ahead',              category: 'Street',       description: "Neither of them knew they were a photograph.", aspectRatio: 1.779, licenseType: LicenseType.PERSONAL_USE },
  { id: '47', url: '/images/35.jpg', title: 'Signal Clear',           category: 'Street',       description: "The signal changed. He moved. The rain didn't have an opinion.", aspectRatio: 1.778, licenseType: LicenseType.RIGHTS_MANAGED },
  { id: '48', url: '/images/36.jpg', title: 'Where the Wind Wins',    category: 'Landscape',    description: "Above the clouds, gravity starts losing. Throw something off the edge. It comes back.", aspectRatio: 1.776, licenseType: LicenseType.ROYALTY_FREE },
];
